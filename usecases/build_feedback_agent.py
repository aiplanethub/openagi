...
if __name__ == "__main__":
    agent_list=["Coder", "Reviewer"]
    llm="azure"    
    AgentObjects=[]
    AgentObjects = [
    AIAgent(agentName=agent_list[0], aggregator=0, onAggregationAction=None, creator=None, 
    ...
    AIAgent(agentName=agent_list[1], aggregator=0, onAggregationAction=None,creator=None,role="Reviewer", feedback=True,
